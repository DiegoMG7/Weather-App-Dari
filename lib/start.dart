...
class _StartState extends State<Start> {
  String dropdownValue = 'انتخاب گزینه';
  ...
  void getData(String valueWS) async {
    ...
    try {
      if(weatherData[0] == null)
        Toast.show("دستگاه هواشناسی گزارش نمی دهد", context, duration: Toast.LENGTH_LONG, gravity:  Toast.BOTTOM);
      else{
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Text(                                                                   //name of the App
                      'تخته معلوماتی وضعیت آب و هوا برای قریه',
                      style:TextStyle(
